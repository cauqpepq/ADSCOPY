  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        >
          <div className="flex items-start justify-between border-b border-ink-200 px-5 py-3">
            <div>
              <Dialog.Title className="text-base font-semibold text-ink-800">{title}</Dialog.Title>
              {description && (
            ...
            <Dialog.Close className="rounded p-1 text-ink-400 hover:bg-ink-100 hover:text-ink-600">
              <X className="h-4 w-4" />
            </Dialog.Close>
          </div>
